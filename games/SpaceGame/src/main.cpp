...
public:
    ...
    {
        std::cerr << "Initializing Space Game..." << std::endl;
        ...
        std::cerr << "Color shader loaded successfully" << std::endl;
        ...
        std::cerr << "Texture shader loaded successfully" << std::endl;
...
#endif
        std::cerr << "Game font loaded successfully" << std::endl;
        ...
        try
        {
            ...
            std::cerr << "Star texture loaded: " << starTexture << std::endl;
        }
        catch (...)
        {
            std::cerr << "No star texture found, using primitives only" << std::endl;
        }
    ...
    {
        std::cerr << "Shutting down Space Game..." << std::endl;
